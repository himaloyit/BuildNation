package com.himaloyit.buildnation.sac.rbac.controllers.advice;
...
public class GlobalResponseEntityException {
    ...
    public ResponseEntity<ApiResponse<Object>> handleDuplicateCodeException(DuplicateCodeException ex) {
    ...
    public ResponseEntity<ApiResponse<Object>> handleDataIntegrityViolationException(DataIntegrityViolationException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiResponse.error(HttpStatus.CONFLICT.value(),
                        "Cannot complete this operation: the record is still referenced by other data"));
    }
